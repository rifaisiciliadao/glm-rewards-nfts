...
async function main() {
    ...
    for (let i = 0; i < epochList.length; i++) {
        ...
        if (beneficiary.indexOf('0x') === 0 && rewarded < 100) {
            ...
            try {
                ...
                if (!nftRewarded) {
                    ...
                    const tx = await contract.giveRewardNFT(beneficiary, { gasPrice: gasPrice })
                ...
                console.log("Error rewarding user:", beneficiary)
            }
        } else {
